...
var dropList = document.getElementsByName("CourseId")[0]	
var mapIdPrices = new Map();
for (i=0;i<dropList.length;i++) {
	 mapIdPrices.set(dropList.options[i].value,dropList.options[i].text);
}

dropList.remove()

var idNamesDropList = document.getElementsByName("CourseId")[0];
...
for (i=0;i<idNamesDropList.length;i++) {
	mapNamePrices.set(idNamesDropList.options[i].text,mapIdPrices.get(idNamesDropList.options[i].value));
}

document.getElementsByName("CourseId")[0].addEventListener("change",function(){ 
		document.getElementsByName("Price")[0].value = mapIdPrices.get(document.getElementsByName("CourseId")[0].value);
