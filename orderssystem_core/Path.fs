...
module Admin =
    ...
    let removeStandardVariationItem: StrPath2 = "/admin/removeStandardVariationItem/%s/%s"
    ...
    let removeStandardVariationForCourse: StrPath2 = "/admin/removeStandarVariationForCourse/%s/%s"
    ...
    let roleEnablerObserverCategoriesByCheckBoxesByRoleAndCat: StrPath2 = "/roles/roleEnablerObserverCategoriesByCheckBoxesRoleCat/%s/%s"
