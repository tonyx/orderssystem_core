module OrdersSystem.local
            ...
            let ExistingComment = "existing comment:  "
            let Reset = "Reset"
            let CommentsFor = "comments for "
            let AddSelectableVariation = "add selectable variation   "
            let AddSelectableVariationsFor ="add selectable standard variations for  "
            let ExistingComments = "existing comments"
            let AddSelectableComment = "add selectable comment"
            let AddStandardCommentFor ="add standard comment for "
            let AreYouSureVoidOrder ="are you sure you want to void the order"
            let OrderItemsInProgress ="orderitems in progress"
            let UserIsNotEnabled ="user is not enabled"
            let SwitchVisibility = "switch visibility"    
            let SubCategory = "subcategory"
            let AddSubCategoryOf = "add subcatgory of "
            let Choose = "choose"
            let StandardVariation = "standard variation "
            let StandardVariations = "standard variations " 
            let ExistingSubCategories = "existing subcategories "
            let AddSubCategory = "add subcategory"
            let MergeWithFatherCategory = "merge with father category"
            let ErrorUnexistingCategory = "an error occurred, unexisting category"
            ...
            let SelectableStandardVariations = "Selectable standard variations"
            let ModifySelectableStandardComments = "modify selectable standard comments"
            let SelectableStandardComments = "selectable standard comments"
            let EditUser ="Edit user: "
            let Insert = "insert"
            let NewComment = "new comment"
            let StandardComments = "standard comments"
            let TimeStamp = "time stamp "
            let ProgressivePrintCounterForThisReceipt = "print counter for this order: " 
            let CantAddAnotherAdmin = "can't add another admin"
            let UserNameIsTaken = "sorry this username is already taken. Try another one"
            let ACategoryNamed = "a category with name "
            let ACourseNamed = "a course with name "
            let NameIsUsed = "this name is already used"
            ...
            let AllVisibleCoursesOfCategory = "all visible Courses of category "
            ...
            let SearchCourse = "search course"
            let Search = "search"
